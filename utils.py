...
def get_logger(config):
    pathname = f'./{config.logPath}/{config.seed}_{config.epochs}_{config.batch_size}_{config.learning_rate}_{config.bert_learning_rate}_{time.strftime("%m-%d_%H-%M-%S")}.txt'
